...
const GlobalStyle = createGlobalStyle`
  * {
  ...
  ::selection {
    background: ${themeGet('primary.0', '#000000')};
  ...
  .quantity {
    button.btn {
      border: 1px solid ${themeGet('primary.0', '#000000')};
      svg {
        fill: ${themeGet('primary.0', '#000000')};
      }
      &:hover {
  ...
  .ant-checkbox-checked::after {
    border-color: ${themeGet('primary.0', '#000000')} !important;
  }
  ...
  .ant-radio-group-solid .ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled):hover {
    opacity: 0.9;
    border-color: ${themeGet('primary.0', '#000000')} !important;
    background: ${themeGet('primary.0', '#000000')} !important;
  }
`;
