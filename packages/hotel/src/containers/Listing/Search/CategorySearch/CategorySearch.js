    ...
    <CategorySearchWrapper>
      ...
      <ViewWithPopup
        className={
          ...
          date_range.setReservationDate !== null
            ? 'activated'
            : ''
        }
        key={400}
        ...
        popup={
          <DateRangePicker
            ReservationDateId="ReservationDate-id-category"
            endDateId="endDate-id-category"
            ReservationDate={
              date_range.setReservationDate
                ? moment(date_range.setReservationDate, 'MM-DD-YYYY')
                : null
            }
            endDate={
